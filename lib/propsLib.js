        ...
        switch (model) {
            ...
            case "deerma.humidifier.jsq2w":
                return {
                    ...
                    'custom:water-shortage-fault': "Water_Shortage_Fault",
                    'custom:the-tank-filed': "Water_Level",
                    'custom:humi_sensor_fault': "Humi sensor fault",
                    'custom:temp_sensor_fault': "Temp sensor fault",
                    'custom:overwet-protect': "Overwet protect",
                    'custom:overwet-protect-on': "overwet-protect-on",
